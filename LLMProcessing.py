...
class LLMProcessing:
    ...
    def UserInputProcessing(strInputText):
        ...
        2. You need to analize it and based on it identiy the action they want to perfrom from [Create,Read,Update,Delete] and Give the MessageTitle with complete info.
