...
def PerfromDBTask(strInputText):
    ...
    all_tasks = fetch_all_data()  # Ensure this function returns a list of tasks
    strAllTasks = ''
    for task in all_tasks:
        strAllTasks += str(task) + '\n'
...
if __name__ == '__main__':
    print(UserInputProcessing("Add a task about cleaning labtop with low priority and status as inprogress"))
